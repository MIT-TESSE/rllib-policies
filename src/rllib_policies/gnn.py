...
class GCN(torch.nn.Module, ABC):
    def __init__(
        ...
        # if len(embedding_size) > 0 and embedding_method is GCNEmbedding.NONE:
        #     layers = [graph_conv_features[-1]] + embedding_size
        #     self.dense_layers = self._get_dense_layers(layers)
